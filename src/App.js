  ...
  return (
    <div className = "wrapper">
        ...
        <header className= "header">
            <div className="header__left-side">
                ...
                <span className="header__span">
                    ...
                    <p className="header__title">Магазин лучших кроссовок</p>
                </span>
            </div>
            <div className="header__right-side">
                <ul className="header__list">
                    <li>
                        <span className="header__button header__button_basket">
                    ...
                    <li>
                        <span className="header__button header__button_liked">
                    ...
                    <li>
                        <span className="header__button header__button_office">
        ...
        <div className="content">
            ...
            <div className="content__sneakers-bar">
                ...
                <div className="content__sneakers">
                    <div className="content_sneakers-row">
                        <div className="content__sneaker-block">
                            <img src="assets/like.svg" alt="" className="content__like"/>

                            <img src="assets/image 1.png" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                            <img src="assets/plus.svg" alt="" className="content__plus"/>
                        </div>

                        <div className="content__sneaker-block">
                            <img src="assets/like.svg" alt="" className="content__like"/>

                            <img src="assets/image 2.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                        ...
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 3.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                        ...
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 4.png" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                    ...
                    <div className="content_sneakers-row">
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 5.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                        ...
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 6.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                        ...
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 7.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                        ...
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 8.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                    ...
                    <div className="content_sneakers-row">
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 9.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
                        ...
                        <div className="content__sneaker-block">
                            ...
                            <img src="assets/image 10.jpg" alt="" className="content__sneaker-img"/>
                            <div className="content__sneaker-text">
                                <p className="content__sneaker-description">Мужские кроссовки <br/> Nike blazer Mid suede</p>
                                <p className="content__sneaker-price">Цена: <br/> <strong className="price">12000 тг</strong></p>
                            </div>
